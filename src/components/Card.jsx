...
function Card() {
  return (
    ...
    <div class="content">
      ...
      <span class="logo-bottom-text">Shohdidor</span>
    </div>
    <span class="bottom-text">Peter Parker</span>
  </div>
    </>
  )
}
...
function Card2 ( { productIMG , Information }) {
  ...
  return (
    <>
    <div>
        <div data-aos="zoom-in-right" className='duration-200 ease-in-out'>
            <img className='w-[450px]' src={productIMG} alt="Product IMG" />
        </div>
        <div className='mt-[-180px] px-[50px] mb-[90px]'>
            <h1 className='Welcome text-white relative ml-[-10px] cursor-default text-[35px] duration-200 ease-in-out hover:text-black'>
                {Information}
            </h1>
            <a href="#part1" >
            <button class="btn ml-[60px]">Shop now</button>
            </a>
